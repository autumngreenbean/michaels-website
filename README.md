A simple custom framework for a musician's website portfolio.

Modular template enabling client-side modifications via custom pipeline Google Sheets > Github > JSON > Website 
